...
. ../../settings.bash
export IMAGE_NAME=${BASE_REGISTRY:+${BASE_REGISTRY}/}developmentimage/ros2_foxy_20.04

export BASE_IMAGE=nvidia/opengl:1.2-glvnd-devel-ubuntu20.04
export INSTALL_SCRIPT=install_ros2_dependencies.bash
export INSTALL_ARGS=foxy
